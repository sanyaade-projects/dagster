...
from dagster._core.events import DagsterEvent, EngineEventData, JobFailureReason
        ...
        if job_canceled_info:
            ...
            if reloaded_run and reloaded_run.status == DagsterRunStatus.CANCELING:
                ...
                event = DagsterEvent.job_failure(
                    ...
                    failure_reason=JobFailureReason.UNEXPECTED_TERMINATION,
            ...
            event = DagsterEvent.job_failure(
                ...
                failure_reason=JobFailureReason.RUN_EXCEPTION,
            ...
            event = DagsterEvent.job_failure(
                ...
                failure_reason=JobFailureReason.STEP_FAILURE,
            )
        else:
